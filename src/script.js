...
// Wall
const wallColorTexture = textureLoader.load('./wall/rock_wall_13_1k/rock_wall_13_diff_1k.webp')
const wallARMTexture = textureLoader.load('./wall/rock_wall_13_1k/rock_wall_13_arm_1k.webp')
const wallNormalTexture = textureLoader.load('./wall/rock_wall_13_1k/rock_wall_13_nor_gl_1k.webp')
...
door.position.y = 1
door.position.z = 2 + 0.01 // Fixing the z-fighting
house.add(door)
// Bushes
...
const helper = new THREE.PointLightHelper(doorLight, 0.2);
